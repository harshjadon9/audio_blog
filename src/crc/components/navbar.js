...
const Navbar = ({classes}) => {
    ...
    return (
        <nav className={" lg:visible md:visible invisible absolute w-full mt-12 transition-colors duration-500 lg:z-50 border-slate-300 border-1 top-0 z-50 flex text-left text-dark px-4 lg:px-10 py-4 font-medium text-sm place-items-center "+classes}>

                ...
                <div className="text-gray-500 ">
                    <div className="grid lg:flex my-3 px-7">
                        ...
                        <div className="flex space-x-6 m-auto lg:m-0 self-end">
                            <a href="#">
                                <svg width="20" height="20" fill="currentColor" class="text-xl  hover:text-xlight transition-colors duration-200" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="text-xl  hover:text-xlight transition-colors duration-200" viewBox="0 0 1792 1792">
